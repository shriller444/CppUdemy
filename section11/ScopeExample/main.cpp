...
int main() {
    ...
    int num {100};  // Local to main as these are inside the function 
    int num1 {500}; // Local to main
    
    cout << "Local num is : " << num << " in main" << endl;
    
    {   // creates a new level of scope
        int num {200};  // local to this inner block therefore is used as it goes from the inside to out
        cout << "Local num is: " << num << " in inner block in main" << endl;
        cout << "Inner block in main can see out - num1 is: " << num1 << endl; // displays 500 as it can see out, outer cant see inwards. 
    }
