...
ProjectPath            :=D:/UdemyMain/c++/section11/FunctionPrototypes
...
../build-$(ConfigurationName)/FunctionPrototypes/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/FunctionPrototypes/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/UdemyMain/c++/section11/FunctionPrototypes/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
