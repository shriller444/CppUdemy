...
void prin_vector(const vector<string> &v); // dont need to declare any variable names its just for documentation 
...
void print_vector(const vector<string> &v){ // always declare print references as constant to prevent things form being changed. 
    for (auto s:v){
        cout << s << "";
    }
