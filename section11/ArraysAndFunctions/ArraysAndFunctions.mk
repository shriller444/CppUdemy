...
ProjectPath            :=D:/UdemyMain/c++/section11/ArraysAndFunctions
...
../build-$(ConfigurationName)/ArraysAndFunctions/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/ArraysAndFunctions/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/UdemyMain/c++/section11/ArraysAndFunctions/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
