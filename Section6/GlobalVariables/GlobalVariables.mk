...
ProjectPath            :=D:/UdemyMain/c++/Section6/GlobalVariables
...
$(OutputFile): ../build-$(ConfigurationName)/GlobalVariables/.d $(Objects) 
	@if not exist "..\build-$(ConfigurationName)\GlobalVariables" mkdir "..\build-$(ConfigurationName)\GlobalVariables"
...
../build-$(ConfigurationName)/GlobalVariables/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/GlobalVariables/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/UdemyMain/c++/Section6/GlobalVariables/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
