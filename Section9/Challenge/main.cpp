...
int main() {
    ...
    do {
        ...
        // has to be single quotes as otherwise it would be a string not a character 
        ...
        if (selection == 'P' || selection == 'p'){
            ...
            if (myList.size() == 0){
                ...
                cout << "Mean of numbers: " << static_cast<double>(total) / myList.size() << endl;
            }
        }
        
        else if (selection == 'S' || selection == 's' || selection == 'L' || selection == 'l'){
            int number {myList[0]};
            string variable = "";
            for (auto val: myList){
            ...
            myList.clear();
            cout << "List has been cleared of all numbers " << endl;
        }
            ...
            cout << "There are " << count << " occurences of " << number << " in the list" << endl;
        }
        else if (selection == 'Q' || selection == 'q'){
            cout << "Goodbye nigga!!! " << endl;
