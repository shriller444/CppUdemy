...
ProjectPath            :=D:/UdemyMain/c++/Section13/CopyConstructor
...
Objects0=../build-$(ConfigurationName)/CopyConstructor/main.cpp$(ObjectSuffix) 
...
$(OutputFile): ../build-$(ConfigurationName)/CopyConstructor/.d $(Objects) 
	@if not exist "..\build-$(ConfigurationName)\CopyConstructor" mkdir "..\build-$(ConfigurationName)\CopyConstructor"
...
../build-$(ConfigurationName)/CopyConstructor/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/CopyConstructor/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/UdemyMain/c++/Section13/CopyConstructor/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
