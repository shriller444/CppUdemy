...
ProjectPath            :=D:/UdemyMain/c++/section12/test
...
../build-$(ConfigurationName)/test/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/test/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/UdemyMain/c++/section12/test/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
