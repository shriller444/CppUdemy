...
ProjectPath            :=D:/UdemyMain/c++/Section20/Stack
...
../build-$(ConfigurationName)/Stack/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Stack/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/UdemyMain/c++/Section20/Stack/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
